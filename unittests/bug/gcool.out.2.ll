...
@Main4VT = constant <{ %ClassInfo, [4 x i32 (...)*] }> <{ %ClassInfo <{ %VTable* bitcast (<{ %ClassInfo, [3 x i32 (...)*] }>* @Main2VT to %VTable*), i64 3, i32* null, i32* null }>, [4 x i32 (...)*] [i32 (...)* bitcast (%FatPointer ()* @Main4.0new to i32 (...)*), i32 (...)* bitcast (%FatPointer (%FatPointer)* @Object.opisvoid to i32 (...)*), i32 (...)* bitcast (%FatPointer (%FatPointer)* @Main.main to i32 (...)*), i32 (...)* bitcast (%FatPointer (%FatPointer, %FatPointer, %FatPointer)* @Main4.hello to i32 (...)*)] }>
...
entry:
  ...
  %self.heapObj1 = extractvalue %FatPointer %0, 1
  %2 = getelementptr [0 x %FatPointer], [0 x %FatPointer]* %self.heapObj1, i32 0, i32 1
  %d.val2 = load %FatPointer, %FatPointer* %2, align 1
  %3 = extractvalue %FatPointer %Main4.val, 0
  %4 = getelementptr %VTable, %VTable* %3, i32 0, i32 1, i32 3
  %5 = bitcast i32 (...)** %4 to %FatPointer (%FatPointer, %FatPointer, %FatPointer)**
  %6 = load %FatPointer (%FatPointer, %FatPointer, %FatPointer)*, %FatPointer (%FatPointer, %FatPointer, %FatPointer)** %5, align 8
  %7 = call %FatPointer %6(%FatPointer %Main4.val, %FatPointer %d.val, %FatPointer %d.val2)
  ret %FatPointer %7
}
...
define %FatPointer @Main4.hello(%FatPointer %0, %FatPointer %1, %FatPointer %2) {
entry:
  %LocalVars = alloca %FatPointer, align 8, addrspace(2)
  %i = getelementptr %FatPointer, %FatPointer addrspace(2)* %LocalVars, i32 0
  store %FatPointer %1, %FatPointer addrspace(2)* %i, align 1
  %i2 = getelementptr %FatPointer, %FatPointer addrspace(2)* %LocalVars, i32 1
  store %FatPointer %2, %FatPointer addrspace(2)* %i2, align 1
  %i1 = getelementptr %FatPointer, %FatPointer addrspace(2)* %LocalVars, i32 0
  %i.val = load %FatPointer, %FatPointer addrspace(2)* %i1, align 1
