; ModuleID = 'GCoolRuntime.c'
source_filename = "GCoolRuntime.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree nounwind uwtable willreturn
define dso_local noalias i8* @gcool_malloc(i64 %size) local_unnamed_addr #0 {
entry:
  %call = tail call noalias align 16 i8* @malloc(i64 %size) #2
  ret i8* %call
}
